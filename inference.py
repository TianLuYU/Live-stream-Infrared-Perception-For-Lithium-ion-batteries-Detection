...
def main(args):
        ...
        for i in range(vis_num):
            ...
            for inst_id in hit_dict.keys():
                ...
                for class_id in hit_dict[inst_id]:
                    ...
                    instance = {'height': 417, 'width': 1074, 'video_id':id_, 'video_name': file_names[0].split('/')[0], 'score': float(score), 'category_id': int(category_id)}  
                    segmentation = []
    ...
    ytvos = 'ytvos'
    ytvos_eval(result_file, ['bbox'], '/content/drive/MyDrive/Tian/Seqformer_me/ytvis_32view/annotations/instances_test_sub.json', max_dets=(100, 300, 1000), get_boundary=True)
    ytvos_eval(result_file, ['segm'], '/content/drive/MyDrive/Tian/Seqformer_me/ytvis_32view/annotations/instances_test_sub.json', max_dets=(100, 300, 1000), get_boundary=False)
