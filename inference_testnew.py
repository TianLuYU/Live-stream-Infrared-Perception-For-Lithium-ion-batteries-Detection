...
def get_args_parser():
    ...
    parser.add_argument('--save_path', default='results_test100ResNet.json')
...
def main(args):
    ...
    with torch.no_grad():
        ...
        # checkpoint['model'].pop("controller.layers.2.weight")
        # checkpoint['model'].pop("controller.layers.2.bias")
    ...
    # result_file = "/content/results_test.json"
