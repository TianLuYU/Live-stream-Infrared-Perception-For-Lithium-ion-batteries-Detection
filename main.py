...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--pretrain_weights', type=str, default="./weights/r50_weight.pth", help="Path to the pretrained model. If set, only the mask head will be trained")

    # * Backbone
    parser.add_argument('--backbone', default='resnet50', type=str, help="Name of the convolutional backbone to use: [resnet50, resnet101, resnext101_32x8d, swin_l_p4w12]")
    ...
    # * Segmentation
    parser.add_argument('--masks', default=True, action='store_true', help="Train segmentation head if the flag is provided")
    ...
    parser.add_argument('--ytvis_path', default="./ytvis_32view", type=str)
...
def main(args):
    ...
    lr_scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, 'min', factor=0.1, patience=10, verbose=True)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        lr_scheduler.step(train_stats['loss'])
        if args.output_dir:
